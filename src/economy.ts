...
export const WEAR_SHAPES = [
  ...
  { id: "beret", label: "ベレー帽" },
  { id: "cap", label: "キャップ" },
  { id: "witch", label: "魔女の帽子" },
  { id: "santa", label: "サンタ帽" },
  { id: "oni", label: "おにのつの" },
  { id: "kanzashi", label: "桜のかんざし" },
  { id: "headphones", label: "ヘッドホン" },
  { id: "glasses", label: "まるメガネ" },
] as const;
export const EFFECT_KINDS = [
  ...
  { id: "sakura", label: "桜ふぶき" },
  { id: "stars", label: "星のシャワー" },
  { id: "snow", label: "雪" },
  { id: "notes", label: "音符" },
] as const;
...
export const BUILTIN_ITEMS: ShopItem[] = [
  ...
  // ---- 2026-09-24 追加の30点 ----
  wear("w-cat-black", "ねこみみ（くろ）", "cat", "#3a3440", 70, "🐈‍⬛", "ぴんと立った黒ねこのみみ", 200),
  wear("w-cat-white", "ねこみみ（しろ）", "cat", "#f6f4f0", 70, "🐱", "ふわふわ白ねこのみみ", 201),
  wear("w-bunny-white", "うさみみ（しろ）", "bunny", "#f8f6f2", 80, "🐰", "ながーい白うさぎのみみ", 202),
  wear("w-bunny-pink", "うさみみ（ピンク）", "bunny", "#ffb3cf", 80, "🐇", "ピンクのうさぎのみみ", 203),
  wear("w-beret-red", "ベレー帽（あか）", "beret", "#d8443a", 60, "🎨", "絵かきさんの赤いベレー帽", 204),
  wear("w-beret-navy", "ベレー帽（こん）", "beret", "#2f3f6a", 60, "🧢", "おちついた紺のベレー帽", 205),
  wear("w-cap-blue", "キャップ（あお）", "cap", "#3f7bff", 50, "🧢", "元気な青いキャップ", 206),
  wear("w-cap-yellow", "キャップ（きいろ）", "cap", "#ffd23f", 50, "🧢", "よく目立つ黄色いキャップ", 207),
  wear("w-witch", "魔女の帽子", "witch", "#3a2a5a", 130, "🧙", "とんがり帽子で、ちょっとふしぎに", 208),
  wear("w-santa", "サンタ帽", "santa", "#d8303a", 90, "🎅", "ふわふわのぼんぼんつき", 209),
  wear("w-oni", "おにのつの", "oni", "#ff5a4a", 60, "👹", "節分の、かわいいおにのつの", 210),
  wear("w-kanzashi", "桜のかんざし", "kanzashi", "#ffb3cf", 110, "🌸", "和の髪かざり。桜が3輪", 211),
  wear("w-headphones", "ヘッドホン（しろ）", "headphones", "#f4f1ea", 100, "🎧", "音楽好きのしるし", 212),
  wear("w-headphones-pink", "ヘッドホン（ピンク）", "headphones", "#ff7aa8", 100, "🎧", "ピンクのヘッドホン", 213),
  wear("w-glasses", "まるメガネ（くろ）", "glasses", "#2a2440", 70, "👓", "ものしりな雰囲気に", 214),
  wear("w-glasses-red", "まるメガネ（あか）", "glasses", "#d8443a", 70, "👓", "おしゃれな赤ぶち", 215),
  wear("w-ribbon-blue", "水色のリボン", "ribbon", "#6fc8ff", 40, "🎀", "さわやかな水色", 216),
  wear("w-ribbon-red", "赤いリボン", "ribbon", "#e8304a", 40, "🎀", "お祝いの赤いリボン", 217),
  wear("w-flower-pink", "桜いろのお花", "flower", "#ffb3cf", 40, "🌸", "春のやさしい色", 218),
  wear("w-flower-white", "しろいお花", "flower", "#ffffff", 40, "🌼", "清らかな白いお花", 219),
  wear("w-leaf-autumn", "もみじのはっぱ", "leaf", "#f07a3a", 40, "🍁", "秋のいろ", 220),
  wear("w-star-pink", "ピンクの星", "star", "#ff8fc8", 60, "🌟", "きらりとピンクに光る", 221),
  wear("w-strawhat-white", "夏の帽子（しろ）", "strawhat", "#f6efe2", 80, "👒", "白いつばひろ帽子", 222),
  wear("w-tophat-red", "あかいシルクハット", "tophat", "#b8303a", 130, "🎩", "パーティーの主役に", 223),
  wear("w-crown-silver", "銀の王冠", "crown", "#d8dce6", 180, "👑", "しずかに輝く銀の王冠", 224),
  wear("w-halo-pink", "ピンクの光の輪", "halo", "#ffc8e0", 150, "💫", "ほんのりピンクの光の輪", 225),
  effect("e-sakura", "桜ふぶき", "sakura", 15, "🌸", "桜の花びらが舞う", 300),
  effect("e-stars", "星のシャワー", "stars", 15, "✨", "星がきらきら降ってくる", 301),
  effect("e-snow", "雪ふらし", "snow", 12, "❄️", "ちらちらと雪が降る", 302),
  effect("e-notes", "音符ダンス", "notes", 12, "🎵", "音符がくるくる踊る", 303),
];

export const BUILTIN_SHOPS: Shop[] = [
  { id: "zakka", name: "ひろばの雑貨屋", description: "頭のかざりと、ちょっとした演出", keeper: "いらっしゃい！ 遊んで貯めたコインで、おしゃれしていってね", itemIds: ["w-ribbon", "w-ribbon-blue", "w-ribbon-red", "w-flower", "w-leaf", "w-star", "w-star-pink", "w-cap-blue", "w-cap-yellow", "w-beret-red", "w-beret-navy", "e-bubbles"], active: true, sortOrder: 10, builtin: true },
  { id: "boushi", name: "おかしの国の帽子屋", description: "特別な帽子と王冠", keeper: "とっておきの帽子がそろっていますよ", itemIds: ["w-strawhat", "w-strawhat-white", "w-tophat", "w-tophat-red", "w-witch", "w-santa", "w-halo", "w-halo-pink", "w-crown", "w-crown-silver"], active: true, sortOrder: 20, builtin: true },
  { id: "hanabi", name: "お祭りの花火屋", description: "みんなに見える演出", keeper: "ぱーっと打ち上げて、みんなを楽しませよう！", itemIds: ["e-hanabi", "e-hearts", "e-confetti", "e-bubbles", "e-stars", "e-notes"], active: true, sortOrder: 30, builtin: true },
  { id: "wakomono", name: "桜の神社の和小物屋", description: "和のかざりと、桜の演出", keeper: "ようこそお参りくださいました。和の小物をどうぞ", itemIds: ["w-kanzashi", "w-oni", "w-flower-pink", "w-flower-white", "w-leaf-autumn", "e-sakura"], active: true, sortOrder: 25, builtin: true },
  { id: "fancy", name: "ゆうえんちのファンシーショップ", description: "みみ・ヘッドホン・メガネ", keeper: "今日はどれにする？ つけると気分が変わるよ", itemIds: ["w-cat-black", "w-cat-white", "w-bunny-white", "w-bunny-pink", "w-headphones", "w-headphones-pink", "w-glasses", "w-glasses-red", "e-notes"], active: true, sortOrder: 26, builtin: true },
  { id: "yukimise", name: "雪の里のおみやげ屋", description: "冬のかざりと、雪の演出", keeper: "寒かったでしょう。あったかい帽子もありますよ", itemIds: ["w-santa", "w-beret-red", "w-beret-navy", "e-snow", "e-stars"], active: true, sortOrder: 27, builtin: true },
